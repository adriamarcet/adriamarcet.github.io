...
* Limitació de caràcters. Per exemple: El teu nom d'usuari ha de tindre entre 3 i 20 caràcters. El que has introduït en tenia 24.
* Valors ja assignats. Per exemple: El email exemple@exemple.com ja està en ús, prova un altre.
* Limitació de seguretat. Per exemple: La clau d'accés o password a de tindre com a mínim un caràcter en majúscula.

És important que si amb programació o la tecnologia que estem fent servir no sabem quina suggerència és la correcta no especifiquem molt sinó que emprarem algun comentari més genèric. Si no podem validar el domini del correu, seguint l'exemple anterior, no cal que comentem aquest detall. En aquest cas una fórmula més oberta serà millor, per exemple: Prova a revisar el teu correu electrònic i indica'ns un correcte.
