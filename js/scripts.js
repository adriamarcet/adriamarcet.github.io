...
*/
	function previewImage(file) {
		...
		var previewContainerId = "js-upload-file--preview";
		...
		// Remove the button used to upload file
		$(".c-btn__delete").addClass('c-btn__delete--visible');
		$(".c-btn.c-btn--cta").fadeOut();
	...
	function startOverFromPreview() {
		...
		$("#js-upload-file--preview").find("img").remove();
		$(".c-btn.c-btn--cta").fadeIn();
		$(".c-btn__delete").removeClass('c-btn__delete--visible');
